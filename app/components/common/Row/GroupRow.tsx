...
import {findGroupList} from "@/app/service/group/group.service";
...
const GroupRow = ({active, onSelect}: GroupRowProps) => {
    ...
    useEffect(() => {
        setIsActive(active);
        findGroupList(page, size, dispatch)
    }, []);
                        ...
                        <div className="p-5">
                            ...
                            <div className="w-full flex justify-between">
                                ...
                                <p className="text-sm font-medium">카테고리
                                    <span
                                        className="font-xs bg-green-400 p-2 text-white rounded-full">{group.categoryName}</span>
                                </p>
                            </div>
                            <Link
