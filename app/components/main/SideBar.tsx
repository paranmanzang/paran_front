          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3">우리들의 작은 모임</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">우리들의 작은 공간</span>
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">우리들의 작은 서점</span>
