  ...
  return (  
    <div className="relative w-full">
     <div className="fixed left-0 top-0 min-h-screen w-full">
       <div id="chatHead" className="bg-gray-100 flex justify-end mt-1 bg-opacity-90 text-black">
      {/* PopUp 버튼 */}
        <button
          type="button"
          onClick={togglePopUp}
    ...
    <div className="flex h-[100dvh] justify-center rounded-lg bg-gray-100">
      <section className="w-[20%] bg-gray-900 text-white">
        <div id="chatHead" className="py-3 px-5">
          {/* onClick 시에 내가 참여하고 있는 방 확인 할 수 있도록 */}
           <button type="button" className="font-bold">참여중인 대화방 이름 {">"} </button>
        </div> 
        <ul className="py-3 px-5">
          <li><button type="button" className="py-3 px-5">유저 프로필</button></li>
          <li><button type="button" className="py-3 px-5">유저 프로필</button></li>
          <li><button type="button" className="py-3 px-5">유저 프로필</button></li>
          <li><button type="button" className="py-3 px-5">유저 프로필</button></li>
          <li><button type="button" className="py-3 px-5">유저 프로필</button></li>
      ...
      <article className="flex w-[80%] flex-col bg-blue-400 ">
        <div className="h-[85%] w-full">채팅하는 공간</div>
        <aside className="h-[15%] w-full border">
          <button type="button" className="py-3 px-5 border rounded-full">보내기</button>
        </aside>
      </article>
    </div>
  </div>
